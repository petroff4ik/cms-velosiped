...
class CaptchaNumbersV2 {
	protected $length = 6;
	protected $font = 'fonts/arial.ttf';
	protected $size = 15;
	protected $angle = 10;
	protected $type = 'jpeg';
	protected $height = 40;
	...
	protected $bgColorRed = 240;
	protected $bgColorGreen = 240;
	protected $bgColorBlue = 240;

	// if true then grid is drawn
	protected $drawGrid = false;

	// if true then every grid line will have a different color
	protected $randomGridColor = true;

	// if true then every letter will have a different color
	protected $randomLetterColor = true;
	...
	*/
	function display() {
		...
		switch ($this-> type) {
			case 'jpeg': imagejpeg($image,SITE_DIR."templates/captcha/cap.jpeg"); break;
			case 'png':  imagepng($image,SITE_DIR."templates/captcha/cap.png");  break;
			case 'gif':  imagegif($image,SITE_DIR."templates/captcha/cap.gif");  break;
			default:     imagepng($image,SITE_DIR."templates/captcha/cap.jpeg");  break;
		}
	}
