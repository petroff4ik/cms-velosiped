 ...
 * _getPrototypePages возврашает прототип страницы при условии возврата true _getPagesAbs (отсутсвие страницы но есть сам документ)(формат ишем в модулях)(По сути представляет из себя поля которые вставляются напрямую в id_lang_text)
