...
class Cache_Lite extends error
{
    ...
    *
    * @protected boolean $_fileLocking
    */
    ...
    *
    * @protected boolean $_writeControl
    */
    ...
    *
    * @protected boolean $_readControlType
    */
    ...
    *
    * @protected boolean $_memoryCaching
    */
    ...
    *
    * @protected boolean $_onlyMemoryCaching
    */
    ...
    *
    * @protected int $memoryCachingCounter
    */
    ...
    *
    * @protected int $memoryCachingLimit
    */
    ...
    * special characters...
    *
    * @protected boolean $fileNameProtection
    */
    ...
    *
    * @protected int $_automaticCleaning
    */
    ...
    *
    * @protected int $_hashedDirectoryLevel
    */
    ...
    *
    * @protected int $_hashedDirectoryUmask
    */
       ...
       if (!($dh = opendir($this->_cacheDir))) {
        ...
        while ($file = readdir($dh)) {
            if (($file != '.') && ($file != '..')) {
              ...
              {
              if(strstr($arr[2],md5($id)))$this->_unlink($this->_cacheDir.$file);
              }
            }
            }
    }
    ...
    */
    function raiseError($msg, $code)
    {
		...
		//echo $msg."".$code."".$this->_pearErrorMode;
         $this->print_error($msg."".$code."".$this->_pearErrorMode);
         return ;
    }
    ...
    */
    ...
    function killByGroup($file,$group){
    $arr=explode(",",$group);
    if(count($arr)>0){
    foreach($arr as $key=>$value)if(strstr($file, "(".$value.")")) return true;
    }else{
    if(strstr($file, "(".$group.")")) return true;
    }
    }
